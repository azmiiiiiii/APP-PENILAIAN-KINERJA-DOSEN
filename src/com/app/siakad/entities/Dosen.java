...
public class Dosen extends KoneksiDB{
    public String nik, kd_dosen, nip, nama_pegawai, jk, tmp_lahir, tgl_lahir, agama, alamat;
    public String email, tmt, nama_ibu, sta_menikah;
    public String sta_pegawai, sta_aktif;
...
public void select(){
    ...
    try {
        ...
        while (res.next()) {
            ...
            list.add(new Object[]{"Nik", "Kode Dosen", "Nip", "Nama Pegawai","Jenis Kelamin","Tempat Lahir",
            "Tanggal Lahir","Agama","Alamat","Nomor Telepon 1", "Nomor Telepon 2", "Email", "Tempat","Nama Ibu","Status Menikah",
            "Jumlah Tanggungan","Status Pegawai","Status Aktif"});
        }
        stat.close();
