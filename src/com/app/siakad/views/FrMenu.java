...
import bY_zAii_dLeader.panelMagenta;
...
public class FrMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnKeluar.setFont(new java.awt.Font("Century Gothic", 0, 11)); // NOI18N
        btnKeluar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/app/siakad/icons/remove_delete_exit_close_1545.png"))); // NOI18N
                    ...
                    .addGroup(PanelLeftLayout.createSequentialGroup()
                        .addGroup(PanelLeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(PanelLeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(panelAlpha23, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(panelAlpha22, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addComponent(panelAlpha24, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblKeterangan, javax.swing.GroupLayout.DEFAULT_SIZE, 410, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void lblKaProdiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblKaProdiMouseClicked
        if(evt.getClickCount()==1){
            ...
            lbkaprodi.setForeground(Color.white);
        }
        enabledMenu();
    ...
    private void lblWaliKelasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblWaliKelasMouseClicked
        if(evt.getClickCount()==1){
            ...
            lbwakel.setForeground(Color.white);
        }
        enabledMenu();
    ...
    private void lblDosenMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblDosenMouseClicked
        if(evt.getClickCount()==1){
            ...
            lbdosen.setForeground(Color.white);
        }
        enabledMenu();
    ...
    private void lblMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMhsMouseClicked
        if(evt.getClickCount()==1){
            ...
            lbmhs.setForeground(Color.white);
        }
        enabledMenu();
    ...
    private void lblTUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblTUMouseClicked
        if(evt.getClickCount()==1){
            ...
            lbtu.setForeground(Color.white);
        }
        enabledMenu();
    ...
    private void txtIDUserKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIDUserKeyTyped
        if(txtIDUser.getText().length()==10){
            JOptionPane.showMessageDialog(null, "ID. User tidak boleh lebih dari 5 karakter");
            evt.consume();
        }
